<div class="modal fade dashboard-stat-modal statistics-modal" id="statistics-modal" tabindex="-1" aria-hidden="true"
    data-mdb-backdrop="static">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header py-2">
                <div class="d-flex align-items-center gap-2">
                    <img src="{{ asset('images/internal/icons/modal_icon_stats.png') }}" width="28" height="28"
            ...
            <div class="modal-body px-4">
                ...
                <div class="w-100 position-relative overflow-y-auto rounded-3" data-simplebar
                    ...
                    <table class="table table-striped w-100 table-sm modal-table" id="stats-table">
