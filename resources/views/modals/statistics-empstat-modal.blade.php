        ...
        <div class="modal-content">
            <div class="modal-header py-2">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <h6 class="modal-title mb-0" id="statistics-emp-status-modal-title">Employee Status</h6>
                </div>
            ...
            <div class="modal-body px-4">
                    ...
                    <div class="row mb-2">
                        <div class="col flex-start">
                            <h6 class="text-14 mb-0"><i class="fas fa-caret-right"></i> Segment :
                                <span id="statistic-context" class="rounded-6 text-white px-2">Statistic</span>
                            </h6>
                        </div>
                        <div class="col flex-end">
                            <x-table-length-pager as="emp-stats-table-page-len" />
                            {{-- <div id="emp-stats-table-page-container"></div> --}}
                        </div>
                    </div>
                </div>
                {{-- DATASET TABLE --}}
                <div class="w-100 position-relative overflow-y-auto rounded-3" data-simplebar
                    ...
                    <table class="table table-striped w-100 table-sm modal-table" id="emp-stats-table">
