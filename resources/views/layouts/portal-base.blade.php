...
<body>
    ...
    <!-- Navbar -->
    <nav class="navbar sticky-top px-md-4 navbar-expand-lg navbar-light" id="main-navbar">
        <!-- Container wrapper -->
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 text-14">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white" href="#">Attendances</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container-fluid pt-4 h-100 overflow-hidden">
        ...
        <div class="row px-md-4 mx-md-1 px-0">
