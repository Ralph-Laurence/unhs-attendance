            ...
            <div class="modal-body px-4">
                ...
                <div class="flex-start">
                    ...
                    <a class="btn btn-sm btn-link btn-collapsible" role="button" data-mdb-toggle="collapse"
                        data-mdb-target="#tracing-details-delete" aria-expanded="false" aria-controls="tracing-details-delete"
                ...
                <div class="tracing-details container-fluid text-14 collapse" id="tracing-details-delete">
                    <div class="row mb-2">
