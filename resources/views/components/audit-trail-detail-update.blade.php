            ...
            <div class="modal-body px-4">
                ...
                <div class="description-wrapper mb-2">
                    <small class="description">
                        User "<span class="user">{#user}</span>" updated a record on <span class="date">{#date}</span>,
                ...
                <div data-simplebar class="table-container overflow-y-auto mb-2" style="max-height: 200px;">
                    <table class="table table-sm table-striped table-fixed audit-details-table audit-updates-table">
                        <thead>
                            <tr>
                ...
                <div class="flex-start">
                    ...
                    <a class="btn btn-sm btn-link btn-collapsible" role="button" data-mdb-toggle="collapse"
                        data-mdb-target="#tracing-details-update" aria-expanded="false" aria-controls="tracing-details-update"
                ...
                <div class="tracing-details container-fluid text-14 collapse" id="tracing-details-update">
                    <div class="row mb-2">
...
@push('scripts')
<script src="{{ asset('js/components/audit-trail-detail-update.js') }}"></script>
@endpush